        ...
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-xs">
              Explore, craft, and survive in the dangerous Slipworlds. Your legacy awaits in the abyss.
            </p>
            <div className="mt-6 flex space-x-4">
              <Link href="https://x.com/playprovidence" className="text-muted-foreground hover:text-primary transition-colors">
                <span className="sr-only">Twitter</span>
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </Link>
              <Link href="https://discord.com/invite/9mxcWFfzXh" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <Link href="https://www.facebook.com/PlayProvidence" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <Link href="https://www.instagram.com/playprovidence.io/" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/terminal" className="text-muted-foreground hover:text-primary transition-colors">
                  Terminal
                </Link>
              </li>
            </ul>
          ...
          {/* Dynasty Studios */}
          <div>
            <h3 className="font-semibold text-foreground mb-4">Dynasty Studios</h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="https://playprovidence.io/" className="text-muted-foreground hover:text-primary transition-colors">
                  The Team
        ...
        <div className="mt-12 border-t pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex items-center space-x-4 text-sm text-muted-foreground">
              <Link href="https://playprovidence.io/" className="hover:text-primary transition-colors">
                Terms of Use
              </Link>
              <span>•</span>
              <Link href="https://playprovidence.io/" className="hover:text-primary transition-colors">
